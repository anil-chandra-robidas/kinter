<div class="col-lg-4 col-md-6">
   <article <?php post_class('post-style2'); ?>>
      ...
      <div class="post-body clearfix">
            ...
            <?php
                  ...
                  printf('<div class="post-footer readmore-btn-area"><a class="btn-readmore" href="%1$s"><i class="fas fa-arrow-right"></i> Read More </a></div>',
                  get_the_permalink()
                     );
                  endif;
            ?>
