...
class Kinter_Theme_Includes {
    ...
    public static function init() {
        ...
        add_action('dms_option_types_init', array( __CLASS__, '_action_custom_option_types'));
    }
    ...
    public static function _action_init() {
        ...
        // gogole font
        self::include_isolated( '/hooks/dms-google-fonts.php' );
    ...
    public static function _action_custom_option_types() {
        if (is_admin()) {
            $dir = '/option-types';
            self::include_isolated( $dir . '/new-icon/class-dms-option-type-new-icon.php', 'components');
            self::include_isolated( $dir . '/dms-multi-inline/class-dms-option-type-dms-multi-inline.php', 'components');
